...
import { email, formattedPhone, github, linkedin, phone } from '../../assets/strings';
    ...
    <footer className="bg-slate-900 border-t border-slate-800">
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-xl font-bold text-slate-100 mb-4">{t.quickLinks}</h3>
            <ul className="space-y-2">
              <li>
                <a href="#hero" className="text-slate-400 hover:text-white transition-colors duration-200">
                  {t_links.home}
                </a>
              </li>
              <li>
